defmodule DoublepWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DoublepWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DoublepWeb.Gettext, "errors", msg, opts)
    end
  end
